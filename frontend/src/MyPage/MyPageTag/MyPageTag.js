    ...
    <div className={'body'}>
      <div className={'my-box'}>
        ...
        <div className={'select'}>
          ...
          <Link to={'/instagram/user/save'}><RiBookmarkLine />&nbsp; 저장됨</Link>
          <Link to={'/instagram/user/tag'} className={'click'}><FaHouseUser />&nbsp; 태그됨</Link>
        </div>
        ...
        <div className={'text-boxs'}>
          <div className={'text-box'}>
            <div className={'text-box-icons'}>
              <FaHouseUser className={'text-box-icon'} />{' '}
          ...
          <div className={'my-footer-box'}>
            <div className={'my-navs-box'}>
              <div className={'my-navs'}>
                ...
                <span className={'my-nav'}><a href={'https://developers.facebook.com/docs/instagram'} target={'_blank'}>API</a></span>
