        ...
        <div className={'body'}>
            <div className={'my-box'}>
                ...
                <div className={'select'}>
                    <Link to={'/user'}><BsGrid3X3/>&nbsp; 게시물</Link>
                    <Link to={'/user/save'} className={'click'}><RiBookmarkLine/>&nbsp; 저장됨</Link>
                ...
                <div className={'text-boxs'}>
                    <div className={'text-box'}>
                        <div className={'text-box-icons'}>
                            <RiBookmarkLine className={'text-box-icon'}/> {/*radius 50% border-box 1px solid 색*/}
                        </div>
                        <p>저장됨 없음</p>
                    </div>
                </div>
